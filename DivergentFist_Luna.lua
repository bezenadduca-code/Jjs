...
oldNamecall = hookmetamethod(game, "__namecall", function(self, ...)
    ...
    task.delay(CONFIG.FireDelay, function()
        local forceFire = CONFIG.DashDirection == "Left" or CONFIG.DashDirection == "Right"

        if forceFire then
            -- Side dash — skip facing check, just fire after dash lands
            task.spawn(function()
        ...
        elseif targetRoot and targetRoot.Parent and not isTargetFacingAway(targetRoot) then
